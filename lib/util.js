    ...
    createStructure() {
        try {
            if (this.projectRoot != null) {
                shelljs.mkdir([
                    this.projectRoot + '/src1',
                    this.projectRoot + '/src1/components',
                    this.projectRoot + '/src1/config',
                    this.projectRoot + '/src1/navigation',
                    this.projectRoot + '/src1/screens',
                    this.projectRoot + '/src1/stores',
