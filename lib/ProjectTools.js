...
`;
    ...
    createLocalProperties() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let localProps = `~/Android/Sdk`;
                fs.writeFileSync(this.projectRoot + '/android/loacl.properties', localProps);
            }
            catch (err) {
                return err;
            }
